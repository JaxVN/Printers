# --- CAU HINH MAY IN STCP013 ---
$PrinterName  = "STCP013"
$DriverName   = "HP LaserJet Pro M402-M403 PCL 6"
$PrinterIP    = "10.10.12.204"
$PortName     = "IP_10.10.12.204"
# Thu muc chua driver cua may in nay (sua lai neu ten thu muc thuc te khac)
$DriverFolder = "C:\Soft\Printers\HP LaserJet Pro M402-M403 PCL 6"

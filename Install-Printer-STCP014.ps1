# --- CAU HINH MAY IN STCP014 ---
$PrinterName  = "STCP014"
$DriverName   = "Canon PRO-100 series"
$PrinterIP    = "CNBJNP_F80D60BB2DC7"
$PortName     = "IP_CNBJNP_F80D60BB2DC7"
# Thu muc chua driver cua may in nay (sua lai neu ten thu muc thuc te khac)
$DriverFolder = "C:\Soft\Printers\Canon PRO-100 series"
...
Write-Log "CANH BAO: IP '$PrinterIP' co dinh dang bat thuong (khong giong IPv4), co the la ID thiet bi WSD/Bonjour chu khong phai IP mang. Add-PrinterPort co the loi - kiem tra lai truoc khi chay." "WARN"
